"Projeto Imobiliaria Panda Documento original se encontra no link:https://colab.research.google.com/drive/1zrsGmeBFL_znUMibV_SIU-e_4bU8zL-r"
...
"# Análise exploratória de dados #Qual o valor médio de aluguel por tipo de imóvel? "
...
"# Filtros # **1. Apartamentos que possuem `1 quarto` e `aluguel menor que 1200`**"
...
"# Manipulando os dados # Criando colunas numéricas"
